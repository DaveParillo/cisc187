...
// configuration step. It creates a namespace called `cisc187`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cisc187::cmake::project_name, cisc187::cmake::project_version) };
