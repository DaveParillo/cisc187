...
//
// This is example code from Chapter 21.6.4 "Unordered_map" of
...
int main()
{
    ...
    unordered_map<string,double> dow_weight;            // dow (symbol,weight)
    ...
    unordered_map<string,string> dow_name;              // dow (symbol,name)
    dow_name["MMM"] = "3M Co."; 
