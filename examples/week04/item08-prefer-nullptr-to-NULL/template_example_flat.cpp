...
int    f1(std::shared_ptr<Widget> spw) { std::cout << "f1\n"; return 1; }   // call these only when
double f2(std::unique_ptr<Widget> upw) { std::cout << "f2\n"; return 1.f; } // the appropriate
bool   f3(Widget* pw) { std::cout << "f3\n"; return true; }                 // mutex is locked
